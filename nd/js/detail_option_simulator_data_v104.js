(function(){
    ...
    // Backoffice API base. Example: "https://backoffice.gaggum.co.kr"
    // When this is set, the API becomes the source of truth for simulator data.
    window.ND_OPTION_SIMULATOR_API_BASE = window.ND_OPTION_SIMULATOR_API_BASE || "https://gaggum-warranty.kimzang12.workers.dev";
    window.ND_OPTION_SIMULATOR_ALLOW_LEGACY_FALLBACK = true;
