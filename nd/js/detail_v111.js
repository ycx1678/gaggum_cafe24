$(function(){
    ...
    function activateThumbImage(clickedIndex){
        if (typeof clickedIndex === 'undefined' || clickedIndex === null || clickedIndex < 0) return;
        closeSimulatorPreviewForThumb();
        slide_box_viewer.slideTo(clickedIndex);
        slide_box_thumbs.slideTo(clickedIndex);
    ...
    $(".prd_img_wrap .thumbs").on("click", ".swiper-slide, .swiper-slide a, .swiper-slide img", function(){
        var $slide = $(this).closest(".swiper-slide");
        var clickedIndex = slide_box_thumbs.slides.index($slide);
