(function () {
    ...
    // v203 carries the quote-request delivery address into Cafe24 checkout
    // and submits Cafe24 discount codes only once while their recalculation runs.
    ...
    var QUOTE_SERVICE_PRODUCT_NOS = [1090, 1091];
