(function () {
    ...
    function renderPanel(panel, parentId, categoryIndex) {
        var parent = categoryIndex.byId[parentId];
        ...
        panel.innerHTML = "";
        title.className = "nd-mega-gnb__panel-title";
        title.appendChild(makeLink(parent ? parent.name : "카테고리", categoryUrl(parentId)));
    ...
    function init() {
        ...
        navigation.addEventListener("mouseenter", function () { clearTimeout(closeTimer); });
