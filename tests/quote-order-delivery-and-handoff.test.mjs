...
const script = readFileSync(path.join(root, "nd/js/quote_order_v203.js"), "utf8");
const directScript = /<script src="\/skin-skin16\/nd\/js\/quote_order_v203\.js\?v=20260907v203"><\/script>/;
